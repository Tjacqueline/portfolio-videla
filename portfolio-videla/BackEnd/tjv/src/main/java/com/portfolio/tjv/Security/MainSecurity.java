 ...
 */
package com.portfolio.tjv.Security;

import com.portfolio.tjv.Security.Service.UserDetailsImpl;
import com.portfolio.tjv.Security.jwt.JwtEntryPoint;
import com.portfolio.tjv.Security.jwt.JwtTokenFilter;
...
public class MainSecurity extends WebSecurityConfigurerAdapter{
  ...
  @Override
    protected void configure(HttpSecurity http) throws Exception {
        ...
        List<String> list2 = Arrays.asList(new String[]{"https://frontendtjv.web.app"});
